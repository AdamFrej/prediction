package pl.waw.frej.prediction.persistence.configuration;
...
@ComponentScan("pl.waw.frej.prediction.persistence.collection")
@EnableJpaRepositories("pl.waw.frej.prediction.persistence.database.repository")
public class PersistenceConfig {

    private static final String ENTITY_PACKAGES = "pl.waw.frej.prediction.persistence.database.entity";
